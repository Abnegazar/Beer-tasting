...
define("koAccount", "You don't have an account ?");
define("forgotPassword", "Forgot password ?");
define("okAccount", "You have an account ?");
define("logOut", "Logout");


define("homeTitle", "The platform to record your beer tastings");
define("homeDesc1", "TasteMyBeer is the best tool to record your beer tastings according to the BJCP standards and to browse for other beer tastings.");
define("homeDesc2", "TasteMyBeer assures all tasters that their tastings can only be edited by themselves.");

define("tastings", "Tastings");
define("showTastings", "View tastings");
define("saveTasting", "Record your tasting");

define("view", "View");
define("add", "Add a tasting");
define("settings", "Settings");
define("account", "Account");

define("yourTastings", "My tastings");
define("lastTastings", "Last tastings");
define("newTasting", "New tasting");
...
define("beerStyle", "Beer style");
define("beerStyles", "Beer styles");




define("title", "Title");
define("beerName", "Beer name");
define("bottleInspection", "Bottle inspection");
define("aroma", "Aroma");
define("appearance", "Appearance");
define("flavor", "Flavor");
define("mouthfeel", "Mouthfeel");
define("overallImpression", "Overall impression");
define("stylisticAccuracy", "Stylistic accuracy");
define("technicalMerit", "Technical merit");
define("intangibles", "Intangibles");
define("offFlavors", "Off-Flavors");
